...
//        for
    ...
    function login() {
		...
		$this->load->view('website/product/sign-in');
    ...
    function register() {
        ...
        $data['content'] = 'website/product/sign-up';
        //$this->load->view($this->template, $data);
		$this->load->view('website/header');
		$this->load->view('website/product/sign-up');
        $this->load->view('website/footer');
    }
    ...
    function profile() {
		...
		$this->load->view('website/product/user-profile');
        $this->load->view('website/footer');
    }
