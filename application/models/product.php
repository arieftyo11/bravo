...
class Product extends CI_Model {
    ...
    function getProducts($perPage = null, $offset = null, $key = null) {
        $this->db->select('p.id_promo, p.judul,p.kota,p.negara,p.harga,p.keberangkatan,p.kepulangan,p.durasi, p.kategori, p.minimal, p.deskripsi');
